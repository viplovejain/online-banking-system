...
$gender=  mysqli_real_escape_string($conn,$_REQUEST['staff_gender']);
$dob=  mysqli_real_escape_string($conn,$_REQUEST['staff_dob']);
$status=  mysqli_real_escape_string($conn,$_REQUEST['staff_status']);
$dept=  mysqli_real_escape_string($conn,$_REQUEST['staff_dept']);
$doj=  mysqli_real_escape_string($conn,$_REQUEST['staff_doj']);
